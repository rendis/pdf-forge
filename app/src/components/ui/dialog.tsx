...
// BaseDialogContent: versión sin botón de cierre ni padding automático
// Usar para diálogos personalizados que necesitan control total del layout
  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        'border border-border bg-background p-0 shadow-lg duration-200',
